...
![Hermes Agent Hero Image]({{ '/assets/images/hermes-agent-features.png' | relative_url }})
...
![Hermes Agent Hero Image]({{ '/assets/images/hermes-agent-architecture.png' | relative_url }})
